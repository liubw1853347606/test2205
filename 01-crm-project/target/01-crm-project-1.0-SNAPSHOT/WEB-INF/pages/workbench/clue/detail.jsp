...
<script type="text/javascript">
	...
	$(function(){
		...
		//给搜索框加鼠标弹起事件
		$("#searchActivityTxt").mouseup(function () {
			//收集参数
			var activityName=this.value;
			var clueId='${clue.id}';
			$.ajax({
				url:'workbench/clue/queryActivityForDetailByClueNameId.do',
				data:{
